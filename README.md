...
- Basic experience with ML workflows and experimentation
...
- Certified in **ReactJS**
- Built responsive, reusable UI components
- Worked with state management and component-based architecture
- Focused on performance and clean UI design

### Machine Learning Projects
- Hands-on practice with ML concepts and algorithms
- Implemented basic models using Python
- Worked on data preparation, training, and evaluation
- Exploring real-world use cases and applied learning projects
...
- Reading and applying productivity and self-improvement techniques
